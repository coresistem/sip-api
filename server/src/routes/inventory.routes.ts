 ...
 * Update asset
 */
router.put('/:id', requireRoles('SUPER_ADMIN', 'CLUB_OWNER', 'STAFF'), async (req, res) => {
    try {
 ...
 */
router.post('/:id/maintenance', requireRoles('SUPER_ADMIN', 'CLUB_OWNER', 'STAFF'), async (req, res) => {
    try {
