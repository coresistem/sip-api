...
- [ ] **Actionable Notifications**: 
    - Modifikasi `Notification` model/type untuk mendukung `actionPayload`.
    - UI: Notifikasi integrasi harus memiliki tombol interaksi langsung (Approve/Reject) di dalam dropdown notifikasi atau halaman notifikasi.
