...
## Legal & Compliance (Active Guidance)
*   **A.1 PSE Lingkup Privat**: Csystem WAJIB terdaftar sebagai PSE Lingkup Privat (OSS Kominfo) karena memproses data pribadi (NIK/WA) dan memiliki fitur transaksi e-commerce.
*   **C.8 Tanda Tangan Elektronik**: 
    *   QR CoreId sah sebagai TTE Non-Tersertifikasi (UU ITE) untuk verifikasi operasional.
    *   Dokumen hukum sensitif (DPA) memerlukan rencana integrasi PSrE (Privy/Vida) di masa depan untuk kekuatan pembuktian maksimal.
*   **D.11 Prosedur Insiden Data**: Persiapan teknis mencakup *Immutable Audit Logs*, *Detection Alerts* untuk ekspor massal, dan *Data Masking* pada UI untuk data sensitif.
*   **B.6 Consent Management**: [Backend & Frontend Ready] Desain sistem mendukung *Granular Toggles* (setuju per kategori data) dan *Consent Versioning*. Implementasi mencakup Onboarding Signup dan Profil Security.
...
*   [x] Multi-role verification system (Approval queues).
*   [x] Event registration flow.
*   [x] **Certificate System**: Full generation and verification flow.
*   [x] **Performance Analytics**: Real-time score progression charts for Athletes.
*   [x] **Club Finance**: Initial Schema for Auto-Billing.
