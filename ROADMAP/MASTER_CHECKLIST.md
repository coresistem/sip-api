...
- [x] DOCS_HUB.md as single entry point
- [x] VISION/ folder for philosophy docs
- [x] ROADMAP/ folder for planning docs
- [x] TASKS/ folder for execution docs
- [x] LABS/ folder for experiments
