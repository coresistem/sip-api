...
const NAV_ITEMS: { path: string; icon: typeof LayoutDashboard; label: string; module: ModuleName }[] = [
    ...
    { path: '/jersey/shipping', icon: Truck, label: 'Jersey Logistics', module: 'shipping' },
    ...
    { path: '/marketplace', icon: Package, label: 'Csystem Marketplace', module: 'catalog' },
                ...
                {!location.pathname.startsWith('/marketplace') && (
                    <header className="hidden lg:flex items-center justify-between h-16 px-6 border-b border-dark-800/50 bg-dark-950/80 backdrop-blur-md sticky top-0 z-30" >
                        ...
                        <div className="mr-2">
                            ...
                            >
                                <ShoppingBag size={18} />
                                <span className="text-sm font-semibold hidden sm:inline">Marketplace</span>
                            </NavLink>
                        </div>
