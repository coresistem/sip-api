                                ...
                                <form className="max-w-md mx-auto space-y-4">
                                    ...
                                    <div>
                                        ...
                                        <div className="flex justify-between items-center mt-1">
                                            <p className="text-[10px] sm:text-xs text-dark-500">
                                                Nomor WA aktif untuk verifikasi.
                                            </p>
                                            <button
                                                type="button"
                                                onClick={() => navigate('/login')}
                                                className="text-[10px] sm:text-xs text-primary-400 hover:text-primary-300 font-medium"
                                            >
