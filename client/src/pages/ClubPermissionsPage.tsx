...
const PREVIEW_COMPONENTS: Partial<Record<ModuleName, React.LazyExoticComponent<React.ComponentType<any>>>> = {
    ...
    athletes: lazy(() => import('../pages/AthletesPage')),
    scoring: lazy(() => import('../pages/ScoringPage')),
    schedules: lazy(() => import('../pages/SchedulesPage')),
    attendance: lazy(() => import('../pages/AttendancePage')),
    finance: lazy(() => import('../pages/FinancePage')),
    ...
    digitalcard: lazy(() => import('../pages/DigitalCardPage')),
    archerconfig: lazy(() => import('../pages/ArcherConfigPage')),
    organization: lazy(() => import('../pages/OrganizationPage')),
    manpower: lazy(() => import('../pages/ManpowerPage')),
    filemanager: lazy(() => import('../pages/FileManagerPage')),
    // admin: lazy(() => import('../pages/SuperAdminPage')), // Typically not previewed by Club
    bleep_test: lazy(() => import('../pages/BleepTestPage')),
    // jersey: lazy(() => import('../features/jersey/pages/admin/Dashboard')), // Complex
    athlete_training_schedule: lazy(() => import('../pages/SchedulesPage')), // Reusing SchedulesPage for now
    athlete_archery_guidance: lazy(() => import('../pages/ArcheryGuidancePage')),
    // perpani_management
    schools: lazy(() => import('../pages/SchoolsPage')),
    // quality_control
    notifications: lazy(() => import('../pages/NotificationsPage')),
    audit_logs: lazy(() => import('../pages/AuditLogsPage')),
    history: lazy(() => import('../pages/HistoryPage')),
    shipping: lazy(() => import('../pages/ShippingPage')),
    ...
    club_approval: lazy(() => import('../pages/ClubApprovalPage')),
    licensing: lazy(() => import('../pages/LicensingPage')),
    // event_creation
    enhanced_reports: lazy(() => import('../pages/EnhancedReportsPage')),
    attendance_history: lazy(() => import('../pages/AttendanceHistoryPage')),
    // event_registration
    event_results: lazy(() => import('../pages/EventResultsPage')),
    score_validation: lazy(() => import('../pages/ScoreValidationPage')),
    events: lazy(() => import('../components/dashboard/EODashboard')),
};
