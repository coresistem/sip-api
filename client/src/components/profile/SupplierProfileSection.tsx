...
import {
    User, Phone, Mail, CreditCard, Building2, MapPin, Globe, Package, Star
} from 'lucide-react';
...
const SUPPLIER_CATEGORIES = [
    'Bows', 'Arrows', 'Targets', 'Accessories', 'Apparel',
    'Training Equipment', 'Maintenance', 'Venue', 'Services', 'Other'
];

export default function SupplierProfileSection({ user, onUpdate }: SupplierProfileSectionProps) {
    ...
    const handleChange = (field: keyof SupplierData, value: string | string[]) => {
        ...
        <div className="space-y-6">
            ...
            >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="md:col-span-2">
                        ...
                        {isEditing ? (
                            ...
                            <div className="input flex items-center gap-3">
                                ...
                                <span>{formData.businessName || 'Not set'}</span>
                            </div>
                        )}
                    </div>
                    ...
                    {/* Website */}
                    <div>
                        <label className="label">Website / Store Link</label>
                        {isEditing ? (
                            <input
                                type="url"
            ...
            >
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    <div className="p-4 rounded-lg bg-dark-800/50 text-center">
                        ...
                        <p className="text-sm text-dark-400 mt-1">Products Listed</p>
                    </div>
                    <div className="p-4 rounded-lg bg-dark-800/50 text-center">
                        <p className="text-3xl font-bold text-green-400">0</p>
                        <p className="text-sm text-dark-400 mt-1">Orders</p>
                    </div>
                    <div className="p-4 rounded-lg bg-dark-800/50 text-center">
                        <p className="text-3xl font-bold text-amber-400">-</p>
                        <p className="text-sm text-dark-400 mt-1">Rating</p>
                    </div>
                    <div className="p-4 rounded-lg bg-dark-800/50 text-center">
                        <p className="text-3xl font-bold text-blue-400">0</p>
                        <p className="text-sm text-dark-400 mt-1">Reviews</p>
                    </div>
                </div>
            </motion.div>
        </div>
